...
public final class MarkdownRenderer {
    ...
    public static void drawLine(GuiGraphics g, Font font, String seg,
        ...
        switch (type) {
            ...
            case TODO_OPEN -> {
                drawCheckbox(g, font, x - 11, y, false);
                g.drawString(font, seg, x, y, COL_TEXT, false);
            }
            case TODO_DONE -> {
                drawCheckbox(g, font, x - 11, y, true);
    ...
    public static void drawCheckbox(GuiGraphics g, Font font, int x, int y, boolean checked) {
    ...
    public static List<String> wrapLine(Font font, String line, int maxW) {
        ...
        while (!remaining.isEmpty()) {
            if (font.width(remaining) <= maxW) { result.add(remaining); break; }
